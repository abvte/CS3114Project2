...
//        args[0] = "10";
//        args[1] = "32";
//        args[2] = "reference_input13.txt";
//        SearchTree.main(args);
//        String content = null;
//        File output = new File("reference_output13.txt");
//        try {
//            Scanner scan = new Scanner(output);
//            content = scan.useDelimiter("\\Z").next();
//            scan.close();
 ...
 * Handle(mem,mem,0,pool))); tree.insert(new KVPair(new
 * Handle(mem,mem,3,pool),new Handle(mem,mem,0,pool))); tree.insert(new
 * KVPair(new Handle(mem,mem,3,pool),new Handle(mem,mem,0,pool)));
 * tree.insert(new KVPair(new Handle(mem,mem,3,pool),new
 * Handle(mem,mem,0,pool))); tree.insert(new KVPair(new
 * Handle(mem,mem,3,pool),new Handle(mem,mem,0,pool))); tree.insert(new
 * KVPair(new Handle(mem,mem,3,pool),new Handle(mem,mem,0,pool)));
...
// Handle(mem,mem,1,pool)));
// tree.insert(new KVPair(new Handle(mem,mem,2,pool),new
// Handle(mem,mem,0,pool)));
// tree.insert(new KVPair(new Handle(mem,mem,2,pool),new
// Handle(mem,mem,2,pool)));
// tree.insert(new KVPair(new Handle(mem,mem,3,pool),new
// Handle(mem,mem,1,pool)));
// tree.insert(new KVPair(new Handle(mem,mem,3,pool),new
// Handle(mem,mem,0,pool)));
 ...
 * Handle(mem,mem,0,pool))); tree.insert(new KVPair(new
 * Handle(mem,mem,3,pool),new Handle(mem,mem,0,pool))); tree.insert(new
 * KVPair(new Handle(mem,mem,4,pool),new Handle(mem,mem,0,pool)));
 * tree.insert(new KVPair(new Handle(mem,mem,5,pool),new
 * Handle(mem,mem,0,pool))); tree.insert(new KVPair(new
 * Handle(mem,mem,6,pool),new Handle(mem,mem,0,pool))); tree.insert(new
 * KVPair(new Handle(mem,mem,7,pool),new Handle(mem,mem,0,pool)));
 * tree.insert(new KVPair(new Handle(mem,mem,8,pool),new
 * Handle(mem,mem,0,pool))); tree.insert(new KVPair(new
 * Handle(mem,mem,9,pool),new Handle(mem,mem,0,pool))); tree.insert(new
 * KVPair(new Handle(mem,mem,10,pool),new Handle(mem,mem,0,pool)));
 * tree.insert(new KVPair(new Handle(mem,mem,1,pool),new
 * Handle(mem,mem,0,pool))); tree.insert(new KVPair(new
 * Handle(mem,mem,0,pool),new Handle(mem,mem,0,pool))); tree.insert(new
 * KVPair(new Handle(mem,mem,5,pool),new Handle(mem,mem,0,pool)));
 * tree.insert(new KVPair(new Handle(mem,mem,3,pool),new
 * Handle(mem,mem,0,pool))); tree.insert(new KVPair(new
 * Handle(mem,mem,13,pool),new Handle(mem,mem,0,pool))); tree.insert(new
 * KVPair(new Handle(mem,mem,12,pool),new Handle(mem,mem,0,pool)));
 * tree.print();
 */